<%@page import="com.library.training.web.enums.SearchType"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.library.training.web.beans.Book"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>

<%@include file="../WEB-INF/jspf/left_menu.jspf" %>

<jsp:useBean id="bookList" class="com.library.training.web.beans.BookList" scope="page"/>
